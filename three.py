...
# cursor.execute("UPDATE salary SET staff_salary=110000 WHERE full_name='Dima'")
# cursor.execute("SELECT * FROM salary LIMIT 5")
cursor.execute("SELECT MIN(staff_salary) As SmallestSalary FROM salary")
